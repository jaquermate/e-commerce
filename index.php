...
<html>
    <head>
        <title>Best Store a Ecommerce Online Shopping Category Flat Bootstrap Responsive Website Template | Inicio :: w3layouts</title>
        <!-- for-mobile-apps -->
        ...
        <div class="banner">
            <div class="container">
                <div class="banner-info animated wow zoomIn" data-wow-delay=".5s">
                    <h3>E-mercadillo</h3>
                    <h4>TU <span>Tienda <i>Online</i></span></h4>
                    <div class="wmuSlider example1">
                        <div class="wmuSliderWrapper">
                            ...
                            <article style="position: absolute; width: 100%; opacity: 0;"> 
                                <div class="banner-wrap">
                                    <div class="banner-info1">
                                        <p>Ordenadores de sobremesa, portatiles</p>
                                    </div>
                                </div>
                            </article>
                        </div>
                ...
                <div class="banner-bottom-grids">
                    <div class="banner-bottom-grid-left animated wow slideInLeft" data-wow-delay=".5s">
                        <div class="grid">
                            <figure class="effect-julia">
                                <img src="images/Electronica_Camara_02.jpg" alt=" " class="img-responsive" />
                                <figcaption>
                                    <h3>Mejor <span>Tienda</span><i> de compras online</i></h3>
                                    <div>
                                        <p>Camaras</p>
                                        <p>Objetivos</p>
                                        <p>Lentes</p>
                    ...
                    <div class="banner-bottom-grid-left1 animated wow slideInUp" data-wow-delay=".5s">
                        <div class="banner-bottom-grid-left-grid left1-grid grid-left-grid1">
                            <div class="banner-bottom-grid-left-grid1">
                                <img src="images/Electronica_GPS_07.jpg" alt=" " class="img-responsive" />
                            </div>
                        ...
                        <div class="banner-bottom-grid-left-grid left1-grid grid-left-grid1">
                            <div class="banner-bottom-grid-left-grid1">
                                <img src="images/Electronica_GPS_08.jpg" alt=" " class="img-responsive" />
                            </div>
                            <div class="banner-bottom-grid-left1-position">
                                <div class="banner-bottom-grid-left1-pos1">
                                    <p>Avisador de Radares</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="banner-bottom-grid-right animated wow slideInRight" data-wow-delay=".5s">
                        <div class="banner-bottom-grid-left-grid grid-left-grid1">
                            <div class="banner-bottom-grid-left-grid1">
                                <img src="images/Electronica_TV_06.jpg" alt=" " class="img-responsive" />
                            </div>
                            <div class="grid-left-grid1-pos">
                                <p><b><font color='white' > Las mejores pantallas de TV <span>Colección 2018</span></font></b></p>
                            </div>
                        </div>
                    </div>
                    <div class="clearfix"> </div>
            ...
            <div class="container">
                <div class="collections-bottom-grids">
                    <div class="collections-bottom-grid animated wow slideInLeft" data-wow-delay=".5s">
                        <h3>Hasta 45% <span>de descuento</span></h3>
                    </div>
                </div>
                <div class="newsletter animated wow slideInUp" data-wow-delay=".5s">
                    <h3>Newsletter</h3>
                    <p>Subscribete a nuestras promociones y estarás al tanto de las mejores ofertas</p>
                    <form>
                        <span class="glyphicon glyphicon-envelope" aria-hidden="true"></span>
                        <input type="email" value="Escriba aqui su correo" onfocus="this.value = '';" onblur="if (this.value == '') {
        ...
        <div class="footer">
            <div class="container">
                <div class="footer-grids">
                    ...
                    <div class="col-md-3 footer-grid animated wow slideInLeft" data-wow-delay=".7s">
                        ...
                        <div class="footer-grid-left">
                            <a href="single.php<?php echo "?correo=".$_GET['correo']."&id_usuario=".$_GET['id_usuario']?>"><img src="images/13.jpg" alt=" " class="img-responsive" /></a>
                        </div>
                        <div class="footer-grid-left">
                            <a href="single.php<?php echo "?correo=".$_GET['correo']."&id_usuario=".$_GET['id_usuario']?>"><img src="images/14.jpg" alt=" " class="img-responsive" /></a>
                        </div>
                        <div class="footer-grid-left">
                            <a href="single.php<?php echo "?correo=".$_GET['correo']."&id_usuario=".$_GET['id_usuario']?>"><img src="images/15.jpg" alt=" " class="img-responsive" /></a>
                        </div>
                        <div class="footer-grid-left">
                            <a href="single.php<?php echo "?correo=".$_GET['correo']."&id_usuario=".$_GET['id_usuario']?>"><img src="images/16.jpg" alt=" " class="img-responsive" /></a>
                        </div>
                        <div class="footer-grid-left">
                            <a href="single.php<?php echo "?correo=".$_GET['correo']."&id_usuario=".$_GET['id_usuario']?>"><img src="images/13.jpg" alt=" " class="img-responsive" /></a>
                        </div>
                ...
                <div class="footer-logo animated wow slideInUp" data-wow-delay=".5s">
                    <h2><a href="index.php<?php echo "?correo=".$_GET['correo']."&id_usuario=".$_GET['id_usuario']?>">E-mercadillo <span>compra online</span></a></h2>
                </div>
